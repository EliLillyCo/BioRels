...
{
	removeBlock("rna_tr_expr_bp","VALID");
	return;
}else removeBlock("rna_tr_expr_bp","INVALID");
$STR="TISSUE_ID,TPM\n";
...
if ($LOG_SCALE)changeValue("rna_tr_expr_bp","YAXIS","log10(TPM+1)");
else changeValue("rna_tr_expr_bp","YAXIS","TPM");
changeValue("rna_tr_expr_bp","TAG",$MODULE_DATA['TRANSCRIPT']['TRANSCRIPT_NAME']);
changeValue("rna_tr_expr_bp","ENST",$MODULE_DATA['TRANSCRIPT']['TRANSCRIPT_NAME']);
changeValue("rna_tr_expr_bp","CONTENT",$STR);
changeValue("rna_tr_expr_bp","DOMAIN",substr($STR_C,0,-1));
changeValue("rna_tr_expr_bp","MINMAX",floor($MIN).','.ceil($MAX));
...
changeValue("rna_tr_expr_bp","RANGE",$STR.'</div>');
...
changeValue("rna_tr_expr_bp","TABLE",$STR);
...
if ($AUC_NT==1)
{
	...
	changeValue("rna_tr_expr_bp","INFORMATION",$STR);
}
else if ($AUC_NT<=3)
{
...
changeValue("rna_tr_expr_bp","PUBLI",$STR);
