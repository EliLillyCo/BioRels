...
$PARAMS=array('CHR'=>'','POSITION'=>'','TAXON'=>9606,'STRAND'=>"+",'RANGE'=>50000);
try{
...
$MODULE_DATA['GENE_RANGE']=getChrGeneRange($PARAMS['TAXON'],$PARAMS['STRAND'],$PARAMS['CHR'],$PARAMS['POSITION'],$PARAMS['RANGE']);
