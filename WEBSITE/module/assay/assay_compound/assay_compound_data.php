...
$TARGET=array();
if ($USER_INPUT['PORTAL']['NAME']=='ASSAY')$TARGET=$USER_INPUT['PORTAL']['DATA'];
else $TARGET=assay_portal($USER_INPUT['PARAMS'][0]);

if (isset($TARGET['ASSAY_ENTRY_ID']))
{
	$MODULE_DATA=getAssayInformation($TARGET['ASSAY_ENTRY_ID']);
    $MODULE_DATA['SEARCH']=getAssayOptions($TARGET['ASSAY_ENTRY_ID']);
}
