...
$MODULE_DATA['STAT'] = getCountPubliGene($GN_ENTRY_ID, $FILTERS);
...
if ($MODULE_DATA['STAT']['CO'] != 0) {
	...
	$time = microtime_float();
	$MODULE_DATA['RESULTS'] = getPubliFromGene($GN_ENTRY_ID, array('MIN' => ($PAGE - 1) * $PER_PAGE, 'MAX' => ($PAGE) * $PER_PAGE), $FILTERS);
}
