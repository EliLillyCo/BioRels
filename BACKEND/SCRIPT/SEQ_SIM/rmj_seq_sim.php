...
addLog("Create directory");
	...
	/// Get parent info
	$PMJ_INFO=$GLB_TREE[getJobIDByName('pmj_seq_sim')];
...
function rmj_seq_sim_term()
{
	...
	for ($I=0;$I<50;++$I)
	{
		if (!checkFileExist($W_DIR.'/SCRIPTS/status_DOM_'.$I))$SUCCESS=false;
		if (file_get_contents($W_DIR.'/SCRIPTS/status_DOM_'.$I)!=0)$SUCCESS=false;
		if (!checkFileExist($W_DIR.'/SCRIPTS/status_SEQ_'.$I))$SUCCESS=false;
		if (file_get_contents($W_DIR.'/SCRIPTS/status_SEQ_'.$I)!=0)$SUCCESS=false;
	}
