...
SOURCES += \
    $(TG_DIR)/BACKEND/SRC/BioRels/apps/protalign/main.cpp \
    $(TG_DIR)/BACKEND/SRC/BioRels/apps/protalign/toolprotalign.cpp
...
INCLUDEPATH += $(TG_DIR)/BACKEND/SRC/BioRels//dblibs/dbquery/
DEPENDPATH += $(TG_DIR)/BACKEND/SRC/BioRels//dblibs/dbquery/
INCLUDEPATH += $(TG_DIR)/BACKEND/SRC/BioRels/dblibs/dbcommon/
DEPENDPATH += $(TG_DIR)/BACKEND/SRC/BioRels//dblibs/dbcommon/
...
HEADERS += \
    $(TG_DIR)/BACKEND/SRC/BioRels/apps/protalign/toolprotalign.h
