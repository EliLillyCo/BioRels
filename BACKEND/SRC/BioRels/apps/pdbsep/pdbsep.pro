...
SOURCES +=   $(TG_DIR)/BACKEND/SRC/BioRels/apps/pdbsep/main.cpp \
    $(TG_DIR)/BACKEND/SRC/BioRels/apps/pdbsep/pdbsep.cpp
...
HEADERS += \
    $(TG_DIR)/BACKEND/SRC/BioRels/apps/pdbsep/pdbsep.h
