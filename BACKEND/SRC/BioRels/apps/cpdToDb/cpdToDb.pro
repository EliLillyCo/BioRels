...
INCLUDEPATH += $(TG_DIR)/BACKEND/SRC/BioRels//dblibs/dbcore/
DEPENDPATH += $(TG_DIR)/BACKEND/SRC/BioRels//dblibs/dbcore/
...
SOURCES += \
    $(TG_DIR)/BACKEND/SRC/BioRels/apps/cpdToDb/main.cpp \
    $(TG_DIR)/BACKEND/SRC/BioRels/apps/cpdToDb/extcpdhandler.cpp \
    $(TG_DIR)/BACKEND/SRC/BioRels/apps/cpdToDb/compound.cpp \
    $(TG_DIR)/BACKEND/SRC/BioRels/apps/cpdToDb/cpdtodb.cpp \
    $(TG_DIR)/BACKEND/SRC/BioRels/apps/cpdToDb/mmcifres.cpp \
    $(TG_DIR)/BACKEND/SRC/BioRels/apps/cpdToDb/mmcifreader.cpp \
    $(TG_DIR)/BACKEND/SRC/BioRels/apps/cpdToDb/writememoryclass.cpp \
    $(TG_DIR)/BACKEND/SRC/BioRels/apps/cpdToDb/base64.cpp \
    cpdtoxml.cpp

HEADERS += \
    $(TG_DIR)/BACKEND/SRC/BioRels/apps/cpdToDb/extcpdhandler.h \
    $(TG_DIR)/BACKEND/SRC/BioRels/apps/cpdToDb/compound.h \
    $(TG_DIR)/BACKEND/SRC/BioRels/apps/cpdToDb/mmcifres.h \
    $(TG_DIR)/BACKEND/SRC/BioRels/apps/cpdToDb/cpdtodb.h \
    $(TG_DIR)/BACKEND/SRC/BioRels/apps/cpdToDb/mmcifreader.h \
    $(TG_DIR)/BACKEND/SRC/BioRels/apps/cpdToDb/writememoryclass.h \
     $(TG_DIR)/BACKEND/SRC/BioRels/apps/cpdToDb/base64.h \
    cpdtoxml.h
